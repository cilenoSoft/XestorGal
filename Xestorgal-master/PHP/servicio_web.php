...
class Servicio
{
    ...
    const basededatos = 'id13063405_xest'; //base de datos dwes
    const conexionBD = 'mysql:host=localhost;dbname=' . self::basededatos; //conexion co servidor localhost e base de datos usuarios
    const usuarioBD = 'id13063405_xestorgal'; //usuario da base de datos
    const contrasenaBD = 'X3st0rg41'; //contrasinal da base de datos
